...
public class SSH2Manager {
	...
	public static SSH2Client connect(String host, String user, String password) throws IOException{
...
static class SSH2Client{
		...
		public void execCommand(String cmd, boolean printFeedback) throws IOException{
			if(session != null){
		...
		public void putShell(String localFile, String remoteTargetDirectory) throws IOException{
			put(localFile, remoteTargetDirectory, "0700");
			execCommand("chmod 0700 " + remoteTargetDirectory + baseFileName(localFile), false);
		}
